...
function FormBuilder({ form }: { form: Form }) {
    ...
    useEffect(() => {
        ...
        //hay un pequeño tick porque los elementos son undefined unos segundos, vamos a poner un timeout pero seria mejor hacerlo controlando mientras el valor sea undefined.
